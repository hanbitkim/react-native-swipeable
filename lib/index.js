  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
        ...
        leftActionActivationDistance2 = _this$props.leftActionActivationDistance2,
        ...
        onLeftActionActivate2 = _this$props.onLeftActionActivate2,
        onLeftActionDeactivate = _this$props.onLeftActionDeactivate,
        onLeftActionDeactivate2 = _this$props.onLeftActionDeactivate2,
        ...
        rightActionActivationDistance2 = _this$props.rightActionActivationDistance2,
        ...
        onRightActionActivate2 = _this$props.onRightActionActivate2,
        onRightActionDeactivate = _this$props.onRightActionDeactivate,
        onRightActionDeactivate2 = _this$props.onRightActionDeactivate2,
      ...
      var _this$state2 = _this.state,
        ...
        leftActionActivated2 = _this$state2.leftActionActivated2,
        leftButtonsActivated = _this$state2.leftButtonsActivated,
        rightActionActivated = _this$state2.rightActionActivated,
        rightActionActivated2 = _this$state2.rightActionActivated2,
      ...
      var nextLeftActionActivated2 = leftActionActivated2;
      var nextLeftButtonsActivated = leftButtonsActivated;
      var nextRightActionActivated = rightActionActivated;
      var nextRightActionActivated2 = rightActionActivated2;
      ...
      if (!leftActionActivated2 && canSwipeRight && x >= leftActionActivationDistance2) {
        ...
        onLeftActionActivate2(event, gestureState, _this);
      }
      ...
      if (leftActionActivated2 && canSwipeRight && x < leftActionActivationDistance2) {
        ...
        onLeftActionDeactivate2(event, gestureState, _this);
      }
      ...
      if (!rightActionActivated2 && canSwipeLeft && x <= -rightActionActivationDistance2) {
        ...
        onRightActionActivate2(event, gestureState, _this);
      }
      ...
      if (rightActionActivated2 && canSwipeLeft && x > -rightActionActivationDistance2) {
        ...
        onRightActionDeactivate2(event, gestureState, _this);
      }
      ...
      var needsUpdate = nextLeftActionActivated !== leftActionActivated || nextLeftActionActivated2 !== leftActionActivated2 || nextLeftButtonsActivated !== leftButtonsActivated || nextRightActionActivated !== rightActionActivated || nextRightActionActivated2 !== rightActionActivated2 || nextRightButtonsActivated !== rightButtonsActivated;
      ...
      var _this$props2 = _this.props,
        ...
        onLeftActionRelease2 = _this$props2.onLeftActionRelease2,
        onLeftActionDeactivate = _this$props2.onLeftActionDeactivate,
        onLeftActionDeactivate2 = _this$props2.onLeftActionDeactivate2,
        ...
        onRightActionRelease2 = _this$props2.onRightActionRelease2,
        onRightActionDeactivate = _this$props2.onRightActionDeactivate,
        onRightActionDeactivate2 = _this$props2.onRightActionDeactivate2,
      ...
      var _this$state3 = _this.state,
        ...
        leftActionActivated2 = _this$state3.leftActionActivated2,
        ...
        rightActionActivated2 = _this$state3.rightActionActivated2,
      ...
      var handle = onSwipeRelease(event, gestureState, _this);
      _this.setState({
        swipingReleased: true
      });
      if (handle) {
        return;
      }
      ...
      if (leftActionActivated2) {
        onLeftActionRelease2(event, gestureState, _this);
      }
      ...
      if (rightActionActivated2) {
        onRightActionRelease2(event, gestureState, _this);
      }
      ...
      animationFn(pan, animationConfig).start(function () {
        ...
        var _this$props3 = _this.props,
          ...
          onLeftActionComplete2 = _this$props3.onLeftActionComplete2,
          ...
          onRightActionComplete2 = _this$props3.onRightActionComplete2,
        ...
        if (!_this.state.swipingReleased) {
          return;
        }
        ...
        if (leftActionActivated2) {
          onLeftActionComplete2(event, gestureState, _this);
          onLeftActionDeactivate2(event, gestureState, _this);
        }
        ...
        if (rightActionActivated2) {
          onRightActionComplete2(event, gestureState, _this);
          onRightActionDeactivate2(event, gestureState, _this);
        }
  ...
  _createClass(Swipeable, [{
    ...
    value: function _getReleaseAnimationFn() {
      var _props4 = this.props,
        ...
        leftActionReleaseAnimationFn2 = _props4.leftActionReleaseAnimationFn2,
        ...
        rightActionReleaseAnimationFn2 = _props4.rightActionReleaseAnimationFn2,
      ...
      var _state = this.state,
        ...
        leftActionActivated2 = _state.leftActionActivated2,
        ...
        rightActionActivated2 = _state.rightActionActivated2,
    ...
    value: function _getReleaseAnimationConfig() {
      var _props5 = this.props,
        ...
        leftActionReleaseAnimationConfig2 = _props5.leftActionReleaseAnimationConfig2,
        ...
        rightActionReleaseAnimationConfig2 = _props5.rightActionReleaseAnimationConfig2,
      ...
      var _state2 = this.state,
        ...
        leftActionActivated2 = _state2.leftActionActivated2,
        ...
        rightActionActivated2 = _state2.rightActionActivated2,
    ...
    value: function render() {
      var _props7 = this.props,
        ...
        style = _props7.style,
        disableSwipe = _props7.disableSwipe,
        props = _objectWithoutProperties(_props7, ['children', 'contentContainerStyle', 'style']);
      ...
      var transform = [{
        translateX: pan.x.interpolate({
          inputRange: [-style.width*2, style.width*2],
          outputRange: [-style.width*2 + _reactNative.StyleSheet.hairlineWidth, style.width*2 - _reactNative.StyleSheet.hairlineWidth],
          extrapolate: 'clamp'
        })},
        {rotate: pan.x.interpolate({
            inputRange: [-style.width*2, 0, style.width*2],
      ...
      return _react2.default.createElement(
        _reactNative.View,
        _extends({ style: [styles.container, style] }, !disableSwipe && this._panResponder.panHandlers, props),
        _react2.default.createElement(
          _reactNative.Animated.View,
          { style: [{ transform: transform }, contentContainerStyle] },
          children
        )
      );
    }
...
Swipeable.propTypes = {
  ...
  onLeftActionActivate2: _propTypes.PropTypes.func,
  onLeftActionDeactivate: _propTypes.PropTypes.func,
  onLeftActionDeactivate2: _propTypes.PropTypes.func,
  onLeftActionRelease: _propTypes.PropTypes.func,
  onLeftActionRelease2: _propTypes.PropTypes.func,
  onLeftActionComplete: _propTypes.PropTypes.func,
  onLeftActionComplete2: _propTypes.PropTypes.func,
  leftActionActivationDistance: _propTypes.PropTypes.number,
  leftActionActivationDistance2: _propTypes.PropTypes.number,
  leftActionReleaseAnimationFn: _propTypes.PropTypes.func,
  leftActionReleaseAnimationFn2: _propTypes.PropTypes.func,
  leftActionReleaseAnimationConfig: _propTypes.PropTypes.object,
  leftActionReleaseAnimationConfig2: _propTypes.PropTypes.object,

  // right action lifecycle
  onRightActionActivate: _propTypes.PropTypes.func,
  onRightActionActivate2: _propTypes.PropTypes.func,
  onRightActionDeactivate: _propTypes.PropTypes.func,
  onRightActionDeactivate2: _propTypes.PropTypes.func,
  onRightActionRelease: _propTypes.PropTypes.func,
  onRightActionRelease2: _propTypes.PropTypes.func,
  onRightActionComplete: _propTypes.PropTypes.func,
  onRightActionComplete2: _propTypes.PropTypes.func,
  rightActionActivationDistance: _propTypes.PropTypes.number,
  rightActionActivationDistance2: _propTypes.PropTypes.number,
  rightActionReleaseAnimationFn: _propTypes.PropTypes.func,
  rightActionReleaseAnimationFn2: _propTypes.PropTypes.func,
  rightActionReleaseAnimationConfig: _propTypes.PropTypes.object,
  rightActionReleaseAnimationConfig2: _propTypes.PropTypes.object,
  ...
  disableSwipe: _propTypes.PropTypes.bool,
