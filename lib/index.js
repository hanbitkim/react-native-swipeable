    ...
    value: function render() {
      ...
      var transform = [{
        translateX: pan.x.interpolate({
          ...
          outputRange: [-width*2 + _reactNative.StyleSheet.hairlineWidth, width*2 - _reactNative.StyleSheet.hairlineWidth],
          extrapolate: 'clamp'
        })},
      ...
      return _react2.default.createElement(
        _reactNative.View,
        _extends({ onLayout: this._handleLayout, style: [styles.container, style] }, !disableSwipe && this._panResponder.panHandlers, props),
