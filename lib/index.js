    ...
    value: function render() {
      ...
      var transform = [{
        translateX: pan.x.interpolate({
          ...
          outputRange: [-width + _reactNative.StyleSheet.hairlineWidth, width - _reactNative.StyleSheet.hairlineWidth],
          extrapolate: 'clamp'
        })
      }];
      ...
      return _react2.default.createElement(
        _reactNative.View,
        _extends({ onLayout: this._handleLayout, style: [styles.container, style] }, canSwipeRight && this._panResponder.panHandlers, props),
